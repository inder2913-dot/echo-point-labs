    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button 
          variant="ghost" 
          size="icon"
          className="relative h-9 w-9 rounded-lg border border-border/50 bg-card/50 backdrop-blur-sm hover:bg-card hover:shadow-glow transition-all duration-300"
        >
      ...
      <DropdownMenuContent 
        align="end" 
        className="glass-card border-border/50 backdrop-blur-xl"
      >
        <DropdownMenuItem 
